package com.dapps.ndastro.ui.common.state.customComposables
        ...
        trailingIcon = {
            IconButton(onClick = {
                ...
                val visibleIconAndText = Pair(
                    ...
                    second = stringResource(id = R.string.show_password)
                )

                val hiddenIconAndText = Pair(
                    first = Icons.Outlined.VisibilityOff,
                    second = stringResource(id = R.string.hide_password)
                )
